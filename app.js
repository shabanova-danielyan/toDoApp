...
function readUserInputAndDisplayItNew() {
  ...
  document
    .querySelector(`#btnRemoveItem${newID}`)
    .addEventListener("click", () => removeOneTaskFromPage(newID));
  document
    .querySelector(`#btnMarkDone${newID}`)
    .addEventListener("click", () => onClick(newID));
}
...
document
  ...
  .addEventListener("click", readUserInputAndDisplayItNew);
document
  .querySelector("#clear-btn")
  .addEventListener("click", removeTasksFromPage);
